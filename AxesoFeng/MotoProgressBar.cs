...
namespace AxesoFeng
{
    public partial class MotoProgressBar : UserControl
    {
        ...
        private void Draw3DBorder(Graphics g)
        {
            ...
            //g.DrawLine(pen, this.Width - penWidth, 0, 0, 0);
            //g.DrawLine(pen, 0, 0, 0, this.Height - penWidth);
            //pen = new Pen(Color.White, 1);
            //penWidth = (int)pen.Width;
            //g.DrawLine(pen, 0, this.Height, this.Width - penWidth, this.Height - penWidth);
            //g.DrawLine(pen, this.Width - penWidth, this.Height - penWidth, this.Width - penWidth, 0);
